...
\caption{\label{fig:seg}Template Image, Tissue Segmentation, and Whole Brain Segmentation. We see the areas of white matter, gray matter, cebebrospinal fluid (CSF) in Panel B. We see}
\end{figure}
