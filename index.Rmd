...
```{r make_pngs, echo = FALSE, message = FALSE, results ="hide"}
...
text(x = 70, y = 2e5, labels = "C", cex = 2)
dev.off()
...
```{r seg, message=FALSE, fig.cap="Template Image, Tissue Segmentation, and Whole Brain Segmentation.  We see the areas of white matter, gray matter, cebebrospinal fluid (CSF) in Panel B. We see the whole brain structural segmentation in Panel C. ", results = "markup"}
path  = file.path("index_files", "figure-latex", 
